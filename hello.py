...
pygame.init()
pygame.mixer.init()
pygame.mixer.set_num_channels(32)  # Increase if more are needed
...
sound_sets = {
    'O': {key: (pygame.mixer.Sound(sound_file), pygame.mixer.Channel(i))
          for i, (key, sound_file) in enumerate(zip(
    ...
    'P': {key: (pygame.mixer.Sound("light-rain.mp3"), pygame.mixer.Channel(i + 12))
          for i, key in enumerate([pygame.K_a, pygame.K_b, pygame.K_c, pygame.K_d, pygame.K_e, pygame.K_f, pygame.K_g, pygame.K_h, pygame.K_i, pygame.K_j, pygame.K_k, pygame.K_l])}
}
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key in current_sounds:
                ...
                sound, channel = current_sounds[current_audio_key]
